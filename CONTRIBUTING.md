...
[issues list](https://github.com/netascode/terraform-provider-utils/issues).
...
Documentation is generated using `terraform-plugin-docs`. After making changes to data sources, functions, or their examples, regenerate the documentation:

```shell
go generate
```

This will format example Terraform files, generate the changelog guide, and update the registry documentation.

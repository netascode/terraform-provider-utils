...
```bash
curl -LO https://raw.githubusercontent.com/netascode/terraform-provider-utils/main/sbom/latest/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/netascode/terraform-provider-utils/main/sbom/latest/sbom.cyclonedx.json
```

### Specific Versions
Each release has its own directory:
- `sbom/v0.1.0/sbom.spdx.json`
- `sbom/v0.1.0/sbom.cyclonedx.json`

**Download Example:**
```bash
# Replace VERSION with the desired release version
VERSION=v0.1.0
curl -LO https://raw.githubusercontent.com/netascode/terraform-provider-utils/main/sbom/${VERSION}/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/netascode/terraform-provider-utils/main/sbom/${VERSION}/sbom.cyclonedx.json
```

### Browse All Versions
View the complete SBOM history in the repository:
https://github.com/netascode/terraform-provider-utils/tree/main/sbom
...
```bash
# SPDX format
jq '.packages[] | select(.name != "terraform-provider-utils") | {name, version}' sbom/latest/sbom.spdx.json
...
git diff v0.1.0 v0.2.0 -- sbom/latest/sbom.spdx.json
```
...
```bash
# Clone repository
git clone https://github.com/netascode/terraform-provider-utils.git
...
If you have questions about SBOM usage or find issues with the generated SBOMs, please [open an issue](https://github.com/netascode/terraform-provider-utils/issues) with the `sbom` label.
